        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex flex-wrap gap-1.5 sm:gap-2 text-xs sm:text-sm'>
            <Link
              href='/'
              locale='en'
              className='hover:text-purple-600 px-1.5 py-0.5 rounded hover:bg-purple-50 transition-colors'
            >
              EN
            </Link>
            <Link
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            <div className='flex flex-col sm:flex-row items-start sm:items-center sm:space-x-6 space-y-4 sm:space-y-0'>
              ...
              >
                <Image
                  src='https://cdn.tinykit.app/fatecharts/images/logo.png'
                  alt='FateCharts Logo'
                  width={80}
                  height={80}
                  className='w-full h-full object-cover'
