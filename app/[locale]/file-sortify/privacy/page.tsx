          ...
          <div className='p-8 md:p-12'>
            ...
            <section className='mb-12'>
              ...
              <p className='text-gray-700 mb-6 leading-relaxed'>
                File Sortify is a macOS desktop application focused on local
                file management. We are committed to
                <span className='bg-yellow-100 px-2 py-1 rounded font-semibold'>
                  not collecting, storing, or transmitting any personal user
                  information
                </span>
                .
              </p>
              ...
              <ul className='space-y-3 mb-8'>
                ...
                <li>
                  ...
                  <span className='text-gray-700 ml-2'>
                    We do not record application usage habits, operation
                    frequency, or usage time
                  </span>
                </li>
                <li>
                  <strong className='text-gray-800'>Device Information:</strong>
                  <span className='text-gray-700 ml-2'>
                    We do not collect device models, system versions, or other
                ...
                <li>
                  ...
                  <span className='text-gray-700 ml-2'>
                    We do not read, analyze, or transmit user file content
                  </span>
                </li>
                <li>
                  <strong className='text-gray-800'>Network Data:</strong>
                  <span className='text-gray-700 ml-2'>
                    We do not monitor user network activity or connections
                  </span>
                </li>
              </ul>
              ...
              <ul className='space-y-2'>
                ...
                <li className='text-gray-700'>
                  <strong>File Organization History:</strong> Local records of
                  file movements (maximum 500 records), used for undo
                  functionality
                </li>
                <li className='text-gray-700'>
                  <strong>Application Logs:</strong> Local runtime logs (maximum
                  1000 records)
                </li>
              </ul>
            </section>
            ...
            <section className='mb-12'>
              ...
              <p className='text-gray-700 mb-6'>
                The application requires the following permissions to provide
                file organization services:
              </p>
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>Downloads Folder Access:</strong> Read and write
                  access to user&apos;s Downloads folder
                </li>
                <li className='text-gray-700'>
                  <strong>User-Selected File Access:</strong> Only processes
                  files that users explicitly select for organization
                </li>
                <li className='text-gray-700'>
                  <strong>System Notifications:</strong> Displays notifications
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  ...
                  categorizes files based only on file extensions, not analyzing
                  file content
                </li>
                <li className='text-gray-700'>
                  <strong>Metadata Protection:</strong> Does not read or process
                  file metadata, creation times, or other attributes
                </li>
                <li className='text-gray-700'>
                  <strong>Privacy Protection:</strong> File content remains
                  completely private during processing
                </li>
              </ul>
            </section>
            ...
            <section className='mb-12'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>Update Checks:</strong> Only checks for updates when
                  new versions are available
                </li>
                <li className='text-gray-700'>
                  <strong>No Data Transmission:</strong> No network data
                  transmission beyond necessary update checks
                </li>
                <li className='text-gray-700'>
                  <strong>Offline Operation:</strong> The application can
                  function normally without network connection
                </li>
              </ul>
            </section>
            ...
            <section className='mb-12'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>Application Sandbox:</strong> The application runs in
                  a macOS sandbox environment with limited system access
                </li>
                <li className='text-gray-700'>
                  <strong>Data Integrity:</strong> Hash-based checksum
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>No User Account System:</strong> No user registration
                  or login required
                </li>
                <li className='text-gray-700'>
            ...
            <section className='mb-12'>
              ...
              <p className='text-gray-700 mb-6'>
                File Sortify uses the following open-source frameworks and
                technologies:
              </p>
              <ul className='space-y-3'>
                <li className='text-gray-700'>
              ...
              <p className='text-gray-700 leading-relaxed'>
                All third-party libraries used are open-source software. We
                prioritize libraries with strong privacy protection
                characteristics when making our selections.
              </p>
            </section>
            ...
            <section className='mb-12'>
              ...
              <p className='text-gray-700 mb-4'>
                Users can access and export their local data at any time:
              </p>
              <ul className='list-disc list-inside space-y-1 ml-4 mb-6'>
                ...
                <li className='text-gray-700'>
                  File organization history records
                </li>
              </ul>
              ...
              <ul className='list-disc list-inside space-y-1 ml-4'>
                <li className='text-gray-700'>
                  Revoke file system access through System Preferences
                </li>
                <li className='text-gray-700'>
            ...
            <section className='mb-12'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>File Organization History:</strong> Maximum 500
                  records
                </li>
                <li className='text-gray-700'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>Automatic Cleanup:</strong> History beyond limits is
                  automatically deleted
                </li>
                <li className='text-gray-700'>
                  <strong>User Control:</strong> Users can clear all local data
                  at any time
                </li>
                <li className='text-gray-700'>
            ...
            <section className='mb-12'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>Age Restrictions:</strong> This application is not
                  specifically designed for children under 13
                </li>
                <li className='text-gray-700'>
                  <strong>No Targeted Collection:</strong> We do not
                  intentionally collect personal information from children under
                  13
                </li>
                <li className='text-gray-700'>
                  <strong>Parental Control:</strong> Parents are encouraged to
                  monitor minor children&apos;s usage
                </li>
              </ul>
            </section>
            ...
            <section className='mb-12'>
              ...
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>No Data Transfer:</strong> All data is processed
                  locally on user devices without international transmission
                </li>
                <li className='text-gray-700'>
                  <strong>Local Operation:</strong> Application functionality
                  does not depend on any geographically located data centers
                </li>
              </ul>
            </section>
            ...
            <section className='mb-12'>
              ...
              <p className='text-gray-700 mb-6'>
                File Sortify complies with the following privacy regulations and
                standards:
              </p>
              <ul className='space-y-3'>
                <li className='text-gray-700'>
                  <strong>GDPR:</strong> Complies with EU General Data
                  Protection Regulation
                </li>
                <li className='text-gray-700'>
                  <strong>CCPA:</strong> Complies with California Consumer
                  Privacy Act
                </li>
                <li className='text-gray-700'>
                  <strong>Apple App Store Guidelines:</strong> Complies with
