    ...
    >
      <div className={`${bgColor} w-16 h-16 rounded-full flex items-center justify-center mb-6`}>
        {icon.startsWith('fas') || icon.startsWith('fab') ? (
          <FontAwesomeIcon name={icon as React.ComponentProps<typeof FontAwesomeIcon>['name']} className="text-2xl" style={{ color: 'inherit' }} />
        ) : (
          <Icon name={icon as React.ComponentProps<typeof Icon>['name']} className="text-2xl" style={{ color: 'inherit' }} />
        )}
      </div>
